...
Source0  : https://sourceforge.net/projects/xmlrpc-c/files/Xmlrpc-c%20Super%20Stable/1.51.06/xmlrpc-c-1-51.06.tgz
...
%prep
%setup -q -n xmlrpc-c-1-51.06
cd %{_builddir}/xmlrpc-c-1-51.06
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580236731
...
cp %{_builddir}/xmlrpc-c-1-51.06/doc/COPYING %{buildroot}/usr/share/package-licenses/xmlrpc-c/b43162159176b3f8a25cb43948e3752105a208c2
cp %{_builddir}/xmlrpc-c-1-51.06/lib/abyss/license.txt %{buildroot}/usr/share/package-licenses/xmlrpc-c/62b46a0d87d04659a7b65a6688796391d18e5349
cp %{_builddir}/xmlrpc-c-1-51.06/tools/binmode-rpc-kit/COPYING %{buildroot}/usr/share/package-licenses/xmlrpc-c/f1af756e2961d4294bf819747ff45d34b1cce972
%make_install
